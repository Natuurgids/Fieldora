...
SERVER_HELP_TOPICS = (
    ...
    ServerHelpTopic("projects", "Projects", "user-guide/projects.md", "projects"),
    ServerHelpTopic("capacity", "Capacity", "user-guide/capacity.md", "capacity"),
    ServerHelpTopic("research", "Projects, maps and research", "user-guide/home-and-calendar.md", "research"),
    ServerHelpTopic("dossiers", "Dossiers", "user-guide/dossiers.md", "dossiers"),
    ServerHelpTopic("knowledge", "AI identification and review", "user-guide/ai-and-resources.md", "knowledge"),
    ServerHelpTopic("ai-platform", "AI Platform", "user-guide/ai-platform.md", "aiadmin"),
    ServerHelpTopic("reference-data", "Reference Data", "user-guide/reference-data.md", "reference"),
    ServerHelpTopic("connectors", "Connectors", "user-guide/connectors.md", "connectors"),
    ServerHelpTopic("platform", "Platform", "user-guide/platform.md", "platform"),
    ServerHelpTopic("operations", "Operations", "user-guide/operations.md", "operations"),
