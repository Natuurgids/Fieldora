...
(()=>{
 ...
 style.textContent=`
  #page-operations .top{margin-bottom:8px}#page-operations>.workspace-subnav{margin-bottom:8px}
  #facility-desktop-cockpit{display:grid;grid-template-columns:minmax(205px,18%) minmax(480px,1fr) minmax(280px,25%);height:calc(100vh - 150px);min-height:590px;border:1px solid var(--line);border-radius:10px;overflow:hidden;background:#111a1d}
  #facility-desktop-cockpit .cockpit-pane{min-width:0;min-height:0;background:var(--panel);overflow:auto}#facility-desktop-cockpit .cockpit-pane+.cockpit-pane{border-left:1px solid var(--line)}
  #facility-desktop-cockpit .cockpit-pane-head{position:sticky;top:0;z-index:4;display:flex;gap:7px;align-items:center;min-height:45px;padding:7px 9px;background:#152023;border-bottom:1px solid var(--line)}
  #facility-desktop-cockpit .cockpit-pane-head strong{white-space:nowrap}#facility-desktop-cockpit .cockpit-pane-head input{width:100%;min-width:0;padding:7px 9px}
  #facility-desktop-cockpit .cockpit-tree{padding:5px}#facility-desktop-cockpit .tree-group{margin:5px 0 9px}#facility-desktop-cockpit .tree-label{padding:7px 8px;color:var(--muted);font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.06em}
  #facility-desktop-cockpit .tree-item{width:100%;display:flex;gap:7px;align-items:center;border:0;border-radius:5px;background:transparent;text-align:left;padding:7px 8px;color:#d7e3df}#facility-desktop-cockpit .tree-item:hover,#facility-desktop-cockpit .tree-item[aria-selected="true"]{background:#203b32;color:#fff}#facility-desktop-cockpit .tree-item .tree-icon{width:18px;text-align:center;color:var(--green)}
  #facility-desktop-cockpit .cockpit-center{display:flex;flex-direction:column;overflow:hidden}#facility-desktop-cockpit .cockpit-toolbar{display:flex;gap:7px;align-items:center;flex-wrap:wrap;padding:7px 9px;border-bottom:1px solid var(--line);background:#182326}#facility-desktop-cockpit .cockpit-toolbar .tabs{margin:0}#facility-desktop-cockpit .cockpit-toolbar button,#facility-desktop-cockpit .inspector-tabs button{padding:6px 9px;border-radius:5px;background:transparent}#facility-desktop-cockpit .cockpit-toolbar button.primary,#facility-desktop-cockpit .inspector-tabs button[aria-selected="true"]{background:#254239;border-color:#4f8e6a;color:#fff}
  #facility-desktop-cockpit .cockpit-content{flex:1;overflow:auto;padding:8px}#facility-desktop-cockpit .cockpit-content .card{border-radius:7px}#facility-desktop-cockpit .cockpit-content>.card{border:0;background:transparent;padding:0}#facility-desktop-cockpit .cockpit-content .row{cursor:pointer;border-radius:4px}
  #facility-desktop-cockpit .inspector-tabs{display:flex;gap:4px;position:sticky;top:0;z-index:5;padding:7px;background:#152023;border-bottom:1px solid var(--line)}#facility-desktop-cockpit .inspector-panel{padding:10px}#facility-desktop-cockpit .inspector-panel[hidden]{display:none!important}#facility-desktop-cockpit .inspector-panel pre{white-space:pre-wrap;overflow-wrap:anywhere}#facility-desktop-cockpit .inspector-panel>.card{border:0;background:transparent;padding:0}
  #facility-desktop-cockpit .facility-kinds{display:flex;gap:5px;overflow:auto}#facility-desktop-cockpit .facility-kinds button{white-space:nowrap}#facility-desktop-cockpit .facility-record-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(230px,1fr));gap:8px}#facility-desktop-cockpit .facility-record-grid .row{display:block;border:1px solid var(--line);background:#172427}#facility-desktop-cockpit .facility-record-grid .row>*{display:block;margin:4px 0}
  #facility-desktop-cockpit .facility-map-stage{min-height:270px;border:1px dashed #46605b;border-radius:7px;background:linear-gradient(45deg,#132024 25%,#162529 25%,#162529 50%,#132024 50%,#132024 75%,#162529 75%);background-size:24px 24px;padding:12px}#facility-desktop-cockpit .facility-map-stage h3{margin-top:0}#facility-desktop-cockpit .facility-map-stage .muted{max-width:600px}
  @media(max-width:1180px){#facility-desktop-cockpit{grid-template-columns:210px minmax(430px,1fr) 290px}}
  @media(max-width:900px){#facility-desktop-cockpit{display:block;height:auto;min-height:0}#facility-desktop-cockpit .cockpit-pane{max-height:none;overflow:visible}#facility-desktop-cockpit .cockpit-pane+.cockpit-pane{border-left:0;border-top:1px solid var(--line)}#facility-desktop-cockpit .cockpit-left{max-height:260px;overflow:auto}#facility-desktop-cockpit .cockpit-center{min-height:540px}#facility-desktop-cockpit .cockpit-right{min-height:360px}}
 `;
