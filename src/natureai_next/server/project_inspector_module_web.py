...
(()=>{
 ...
 function render(selection){
  const record=selection?.record||null,metadata=q("project-inspector-metadata"),map=q("project-inspector-map"),activity=q("project-inspector-activity"),title=q("project-cockpit-title");
 ...
 function refresh(){render(selectedRecord()?.current?.()||null)}
