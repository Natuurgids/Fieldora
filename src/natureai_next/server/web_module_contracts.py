...
def normalize_route(route: str) -> str:
    ...
    Query strings and fragments are shell state rather than route ownership and
    are intentionally excluded from registry keys.
    """
...
# Initial shell ownership map.  This is deliberately small: modules are added as
# their desktop-parity audit and integration contract are completed.
